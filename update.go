...
// UpdateExec tries to start an new executable while passing the current TCP listener to have zero downtime
func UpdateExec(addr string, ln net.Listener, execName string) (*os.Process, error) {
